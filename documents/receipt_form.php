...
<div class="max-w-5xl mx-auto p-6">
    ...
    <div class="bg-white rounded-2xl shadow-lg p-8 mb-6 no-print">
        ...
        <div class="mb-6">
            ...
            <select id="issuer_company_id" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
                ...
                <input type="text" id="doc_number" value="<?= $receipt_data['doc_number'] ?? 'RC-'.date('Ymd').'-001' ?>" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500">
            </div>
            <div>
    ...
    const html = `
        <div style="width: 800px; margin: 0 auto; background: white; padding: 20px; font-family: 'Sarabun', sans-serif; color: #000;" id="printable-area">
            <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 10px;">
                <div style="width: 150px;"><img src="../assets/logo/logo.png" style="width: 120px;"></div>
                <div style="flex: 1; text-align: center;">
                    <h1 style="font-size: 18px; font-weight: bold; margin: 0;">${issuer.data('name')}</h1>
                    <p style="font-size: 14px; margin: 2px 0;">${issuer.data('address')}</p>
                    <p style="font-size: 14px; margin: 2px 0;">โทร. ${issuer.data('phone')} ไลน์ OA= @ttgoldenteak</p>
                    <p style="font-size: 14px; margin: 2px 0;">เลขที่ประจำตัวผู้เสียภาษี ${issuer.data('taxid')}</p>
                </div>
