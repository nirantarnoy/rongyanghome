...
function exportPDF() {
    ...
    if (id) {
        window.open('export_pdf.php?type=invoice&id=' + id, '_blank');
    } else {
        Swal.fire({
            ...
            if (res.isConfirmed) {
                saveInvoiceAndExportPDF();
            }
        });
    }
}

function saveInvoiceAndExportPDF() {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (res.status === 'success') {
                ...
                Swal.close();
                window.open('export_pdf.php?type=invoice&id=' + res.id, '_blank');
            } else {
